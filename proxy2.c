...
// helpers
// do upto listen, return socket, negative if error
static int proxy_setup_listen();
// handle each connection in connection list
// return 1 or 2 indicating number of connfd to be removed
